    ...
    <>
      <MobileFrame>
        ...
        <div className='flex flex-col items-center gap-[26px]'>
          ...
          <div className={`text-center font-bold text-3xl ${getMainColor('text')} mb-[60px]`}
            ...
            questionData.questions[questionIndex+1].options.map( (option, index) => {
              ...
              return(
                <>
                  {
                    questionIndex == 0 &&
                    <div className={`bg-[#BEE351] w-full rounded-full text-white py-[16px] text-sm flex justify-center items-center 
                    font-medium shadow-[0px_4px_0px_1px_#90B62A] cursor-pointer hover:translate-y-0.5 transition`}
                  ...
                  {
                    questionIndex == 1 &&
                    <div className={`bg-[#DD3E3E] w-full rounded-full text-white py-[16px] text-sm flex justify-center items-center 
                    font-medium shadow-[0px_4px_0px_1px_#8D4509] cursor-pointer hover:translate-y-0.5 transition`}
                  ...
                  {
                    questionIndex == 2 &&
                    <div className={`bg-[#89BCFF] w-full rounded-full text-white py-[16px] text-sm flex justify-center items-center 
                    font-medium shadow-[0px_4px_0px_1px_#1098EC] cursor-pointer hover:translate-y-0.5 transition`}
        ...
        <Image className='absolute bottom-0 translate-y-1/2 pointer-events-none' src={circle2Img} alt="circle2Img" />
